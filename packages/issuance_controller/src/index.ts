...
export interface Client {
   ...
   */
  initialize: ({admin, asset_registry, kyc_registry, treasury}: {admin: string, asset_registry: string, kyc_registry: string, treasury: string}, options?: {
    /**
   ...
   */
  set_price: ({asset_code, payment_asset, price_per_unit}: {asset_code: string, payment_asset: string, price_per_unit: i128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  set_token_contract: ({asset_code, token_address}: {asset_code: string, token_address: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  add_payment_asset: ({asset_address}: {asset_address: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  remove_payment_asset: ({asset_address}: {asset_address: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  set_treasury: ({new_treasury}: {new_treasury: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  buy: ({buyer, asset_code, amount}: {buyer: string, asset_code: string, amount: i128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  get_price: ({asset_code}: {asset_code: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  get_token_contract: ({asset_code}: {asset_code: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
