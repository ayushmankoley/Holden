...
export interface Client {
   ...
   */
  register_asset: ({admin, asset_code, issuer, metadata_uri}: {admin: string, asset_code: string, issuer: string, metadata_uri: string}, options?: {
    /**
   ...
   */
  update_exposure_ratio: ({admin, asset_code, new_ratio}: {admin: string, asset_code: string, new_ratio: i128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  set_active: ({admin, asset_code, active}: {admin: string, asset_code: string, active: boolean}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  get_asset: ({asset_code}: {asset_code: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
